...
/**
 * A factory to create Cassandra Adapters that work with Cassandra 3.11
 */
@MinimumVersion("3.11.0")
public class Cassandra311Factory extends CassandraFactory
{
    public Cassandra311Factory(DnsResolver dnsResolver)
    {
        super(dnsResolver);
    }
    ...
    {
        return new Cassandra311Adapter(dnsResolver, jmxClient, session);
    }
}
