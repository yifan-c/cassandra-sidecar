...
import static org.apache.cassandra.sidecar.adapters.trunk.ClusterMembershipJmxOperations.FAILURE_DETECTOR_OBJ_NAME;

/**
 * An implementation of the {@link ClusterMembershipOperations} that interfaces with Cassandra 4.0 and later
 */
public class Cassandra311ClusterMembershipOperations implements ClusterMembershipOperations
{
     ...
     */
    public Cassandra311ClusterMembershipOperations(JmxClient jmxClient)
    {
    ...
    {
        return jmxClient.proxy(ClusterMembershipJmxOperations311.class, FAILURE_DETECTOR_OBJ_NAME)
